...
const SlideWrapper: React.FC<{ children: React.ReactNode;[key: string]: any }> = ({ children, currentSlide: _currentSlide, slideCount: _slideCount, ...rest }) => {
...
const LevelsCarousel: React.FC = () => {
    ...
    const _NextArrow = (props: any) => {
        ...
        const { className, style, onClick, currentSlide: _currentSlide, slideCount: _slideCount, ...rest } = props;
